...
public class ContainerBreeder extends Container {
    ...
    public ContainerBreeder(InventoryPlayer player, World world, int x, int y, int z){
        ...
        this.addSlotToContainer(new Slot(craftMatrix, 0, 24, 23));
        this.addSlotToContainer(new Slot(craftMatrix, 1, 24, 47));
    ...
    public boolean canInteractWith(EntityPlayer player){
        if (worldObj.getBlock(posX, posY, posZ) != ModBlocks.breeder){
            return false;
        }else{
