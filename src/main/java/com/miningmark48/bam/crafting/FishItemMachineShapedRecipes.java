...
public class FishItemMachineShapedRecipes implements IRecipe{
    ...
    public FishItemMachineShapedRecipes(int p_i1917_1_, int p_i1917_2_, ItemStack[] p_i1917_3_, ItemStack p_i1917_4_)
    {
    ...
    public FishItemMachineShapedRecipes func_92100_c()
    {
