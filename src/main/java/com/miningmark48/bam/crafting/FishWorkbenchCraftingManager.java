...
public class FishWorkbenchCraftingManager {

    /** The static instance of this class */
    private static final FishWorkbenchCraftingManager instance = new FishWorkbenchCraftingManager();
     ...
     */
    public static final FishWorkbenchCraftingManager getInstance()
    {
        /** The static instance of this class */
        return instance;
    }

    private FishWorkbenchCraftingManager()
    {
        ...
        this.addRecipe(new ItemStack(Items.fishing_rod, 1), new Object[]{"x", "y", "z", 'x', Items.stick, 'y', Blocks.planks, 'z', ModItems.fishingLine});
