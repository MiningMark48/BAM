...
public class FishItemMachineCraftingManager {

    /** The static instance of this class */
    private static final FishItemMachineCraftingManager instance = new FishItemMachineCraftingManager();
     ...
     */
    public static final FishItemMachineCraftingManager getInstance()
    {
        /** The static instance of this class */
        return instance;
    }

    private FishItemMachineCraftingManager()
    {
        ...
        this.addRecipe(new ItemStack(Items.nether_star, 1), new Object[]{"x", "y", 'x', ModItems.aaFish, 'y', Items.diamond});

        Collections.sort(this.recipes, new FishItemMachineRecipeSorter(this));
    }
