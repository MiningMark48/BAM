...
public class EntityBlackHook extends EntityFishHook{
    ...
    public EntityBlackHook(World world) {

        super(world);
    }

    @SideOnly(Side.CLIENT)
    public EntityBlackHook(World world, double x, double y, double z, EntityPlayer player) {

        super(world, x, y, z, player);

    }

    public EntityBlackHook(World world, EntityPlayer player) {
    ...
    public ItemStack getFishingResult()
    {
        ...
        if (x == 1){
            ...
            return new ItemStack(ModItems.clFish);
        }else if (x == 3){
            return new ItemStack(ModItems.clFish2);
        }else if (x == 4){
            return new ItemStack(ModItems.ccFish2);
        }else if (x == 5){
            return new ItemStack(ModItems.gcFish);
        }else if (x == 6){
            return new ItemStack(ModItems.ioFish);
        }else if (x == 7){
            return new ItemStack(ModItems.ioFish2);
        }else if (x == 8){
