...
public class EntityLightBlueHook extends EntityFishHook {
    ...
    public EntityLightBlueHook(World world) {

        super(world);
    }

    @SideOnly(Side.CLIENT)
    public EntityLightBlueHook(World world, double x, double y, double z, EntityPlayer player) {

        super(world, x, y, z, player);

    }

    public EntityLightBlueHook(World world, EntityPlayer player) {
