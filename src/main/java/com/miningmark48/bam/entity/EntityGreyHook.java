...
public class EntityGreyHook extends EntityFishHook{
    ...
    public EntityGreyHook(World world) {

        super(world);
    }

    @SideOnly(Side.CLIENT)
    public EntityGreyHook(World world, double x, double y, double z, EntityPlayer player) {

        super(world, x, y, z, player);

    }

    public EntityGreyHook(World world, EntityPlayer player) {
    ...
    public ItemStack getFishingResult()
    {
        ...
        if (x == 1){
            return new ItemStack(ModItems.ahFish);
        }else if(x == 2){
            return new ItemStack(ModItems.arFish);
        }else if(x == 3){
            return new ItemStack(ModItems.alFish);
        }else if(x == 4){
            return new ItemStack(ModItems.aoFish);
        }else if(x == 5){
            return new ItemStack(ModItems.cfFish);
        }else if(x == 6){
            return new ItemStack(ModItems.sfFish);
        }else if(x == 7){
            return new ItemStack(ModItems.lcFish);
        }else if(x == 8){
            return new ItemStack(ModItems.isFish);
        }else if(x == 9){
            return new ItemStack(ModItems.ajFish);
        }else if(x == 10){
            return new ItemStack(ModItems.mcFish);
        }else if(x == 11){
            return new ItemStack(ModItems.meFish);
        }else if(x == 12){
            return new ItemStack(ModItems.anFish);
        }else if(x == 13){
            return new ItemStack(ModItems.acFish);
        }else if(x == 14){
            return new ItemStack(ModItems.acFish2);
        }else if(x == 15){
            return new ItemStack(ModItems.atFish);
        }else if(x == 16){
            return new ItemStack(ModItems.aaFish3);
        }else if(x == 17){
            return new ItemStack(ModItems.abFish);
        }else if(x == 18){
            return new ItemStack(ModItems.ajFish2);
        }else if(x == 19){
            return new ItemStack(ModItems.arFish2);
        }else if(x == 20){
            return new ItemStack(ModItems.arFish3);
        }else if(x == 21){
            return new ItemStack(ModItems.aspFish4);
        }else if(x == 22){
            return new ItemStack(ModItems.aspFish5);
        }else if(x == 23){
            return new ItemStack(ModItems.aspFish6);
        }else if(x == 24){
            return new ItemStack(ModItems.asFish2);
        }else if(x == 25){
            return new ItemStack(ModItems.asFish3);
        }else if(x == 26){
            return new ItemStack(ModItems.ltFish);
        }else if(x == 27){
