...
import com.miningmark48.bam.entity.EntityGreyHook;
...
public class ItemGreyRod extends ItemFishingRod {
    ...
    public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
        ...
        if (player.fishEntity != null) {
            ...
            if (!world.isRemote) {
                world.spawnEntityInWorld(new EntityGreyHook(world, player));
